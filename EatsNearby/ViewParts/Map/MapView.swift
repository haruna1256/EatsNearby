...
struct MapView: View {
    ...
    var body: some View {
        ...
        .sheet(item: $selectedShop) { shop in
            ...
            DetailPageView(shop: shop){ selectedShop in
                // 詳細画面から渡されたアクションを受け取り、ルート検索を実行
...
struct MapViewView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        MapView(locationManager: locationManager, shops: dummyShops, onFindRoute: { _ in print("Route action triggered in Preview") }, route: nil)
    }
}
